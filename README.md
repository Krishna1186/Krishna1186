## Krishna Nagaraj Nayak

CS undergrad at BITS Pilani, class of 2028.

I'm building [payment-agent-harness](https://github.com/Krishna1186/payment-agent-harness): a sandbox, adversarial scenario suite, and public benchmark for AI agents that move money. UPI is opening up to agentic payments, and agents will be transacting on rails where settlement is instant and reversal is not a normal operation. Nobody has built the layer that measures whether those agents are safe to trust. That's the bet.
...
Smart contract security research. Audit contests on Code4rena and Sherlock.
